    ...
    socket.on('update',
      function(data) {
        ...
        if (typeof players[clientid] !== "undefined"){
          ...
          players[clientid].position = [players[clientid].position[0] + (players[clientid].velocity[0]*deltatime),
           players[clientid].position[1] + (players[clientid].velocity[1]*deltatime)];
